...
document.getElementById(_211+"Img").src="/ibm/console/images/arrow_collapsed.gif";
}
}else{
document.getElementById(_211).style.display=showIt;
if(document.getElementById(_211+"Img")){
document.getElementById(_211+"Img").src="/ibm/console/images/arrow_expanded.gif";
}
}
if(_211=="com_ibm_ws_inlineMessages"){
...
document.getElementById(_212+"Img").src="/ibm/console/images/arrow_expanded.gif";
}
_213="inline";
}else{
document.getElementById(_212).style.display="none";
if(document.getElementById(_212+"Img")){
document.getElementById(_212+"Img").src="/ibm/console/images/arrow_collapsed.gif";
}
_213="none";
}
...
document.getElementById(_214+"Img").src="/ibm/console/images/arrow_expanded.gif";
...
if(document.getElementById(_214+"Img")){
document.getElementById(_214+"Img").src="/ibm/console/images/arrow_collapsed.gif";
...
document.getElementById(_223+"Img").src="/ibm/console/images/IRU_title_minimize.gif";
}else{
...
if(document.getElementById(_223+"Img")){
if(_223=="wasHelpPortlet"&&federationAdder=="10"){
document.getElementById(_223+"Img").src="/ibm/console/images/IRU_title_restore.gif";
}else{
