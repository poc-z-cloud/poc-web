  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('#randomPerson').click(function() {
        $.getJSON('${pageContext.request.contextPath}/mvc/rest/person/random', function(person) {
      ...
      $('#idForm').submit(function(e) {
        ...
        if(!validatePersonId(personId)) 
          return false;
        $.get('${pageContext.request.contextPath}/mvc/rest/person/' + personId, function(person) {
      ...
      $('#newPersonForm').submit(function(e) {
        ...
        $.post('${pageContext.request.contextPath}/mvc/rest/person', $(this).serialize(), function(response) {
